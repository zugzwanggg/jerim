      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          <div className="bg-dark-secondary rounded-xl p-6 shadow-lg">
            ...
            <p className="text-sm text-gray-400 mt-1">Total contribution points</p>
          </div>

          <div className="bg-dark-secondary rounded-xl p-6 shadow-lg">
            <div className="flex items-center gap-3 mb-2">
              <TreePine className="w-6 h-6 text-primary-green" />
              <h3 className="text-xl font-semibold text-white">Trees Planted</h3>
            </div>
            <p className="text-3xl font-bold text-white">{(user.points / 10).toLocaleString()}</p>
            <p className="text-sm text-gray-400 mt-1">Trees planted through contributions</p>
          </div>
          ...
          <div className="bg-dark-secondary rounded-xl p-6 shadow-lg">
            ...
            <p className="text-sm text-gray-400 mt-1">Current leaderboard position</p>
          </div>
        </div>
        ...
        <div className="mt-6 bg-dark-secondary rounded-xl p-6 shadow-lg">
          ...
          <div className="space-y-4">
            {[1, 2, 3].map((_, index) => (
              <div key={index} className="flex items-center gap-4 p-3 rounded-lg bg-dark-color/50">
